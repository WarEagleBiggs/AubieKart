...
//  QuickOutline
//
//  Modified to ignore objects on the OUTLINE layer
//
...
public class Outline : MonoBehaviour {
  ...
  void OnEnable() {
    foreach (var renderer in renderers) {
      if (renderer.gameObject.layer == outlineLayer) continue;
  ...
  void Bake() {
    ...
    foreach (var meshFilter in GetComponentsInChildren<MeshFilter>()) {
      if (meshFilter.gameObject.layer == outlineLayer) continue;
  ...
  void LoadSmoothNormals() {
    ...
    foreach (var skinnedMeshRenderer in GetComponentsInChildren<SkinnedMeshRenderer>()) {
      if (skinnedMeshRenderer.gameObject.layer == outlineLayer) continue;
